...
const ABOUT_CONTENT: Record<string, {
  ...
  en: {
    hero: {
      ...
      subtitle: "CBD Boutique was born from a simple belief: everyone deserves access to premium, lab-tested CBD products that enhance wellbeing naturally."
    },
    philosophy: {
      eyebrow: "Philosophy",
      title: "Nature meets science",
      text1: "We believe in the power of hemp-derived CBD to support balance and wellness. Our journey began in the Swiss Alps, where we discovered the remarkable potential of organically grown hemp.",
    ...
    commitment: {
      ...
      text: "Every CBD Boutique product undergoes rigorous testing to ensure it meets our standards. We publish all lab results so you can shop with complete confidence."
    },
    cta: {
      title: "Experience the difference",
      subtitle: "Discover our curated collection of premium CBD products",
  ...
  es: {
    hero: {
      ...
      subtitle: "CBD Boutique nació de una creencia simple: todos merecen acceso a productos CBD premium, probados en laboratorio, que mejoran el bienestar de forma natural."
    },
    philosophy: {
      eyebrow: "Filosofía",
      title: "La naturaleza se encuentra con la ciencia",
      text1: "Creemos en el poder del CBD derivado del cáñamo para apoyar el equilibrio y el bienestar. Nuestro viaje comenzó en los Alpes suizos, donde descubrimos el notable potencial del cáñamo cultivado orgánicamente.",
    ...
    commitment: {
      ...
      text: "Cada producto CBD Boutique pasa por pruebas rigurosas. Publicamos todos los resultados de laboratorio para que compres con total confianza."
    },
    cta: {
      title: "Experimenta la diferencia",
      subtitle: "Descubre nuestra colección curada de productos CBD premium",
  ...
  de: {
    hero: {
      ...
      subtitle: "CBD Boutique wurde aus einer einfachen Überzeugung geboren: Jeder verdient Zugang zu Premium-CBD-Produkten, die das Wohlbefinden natürlich verbessern."
    },
    philosophy: {
      eyebrow: "Philosophie",
      title: "Natur trifft Wissenschaft",
      text1: "Wir glauben an die Kraft von aus Hanf gewonnenem CBD zur Unterstützung von Balance und Wohlbefinden.",
    ...
    commitment: {
      ...
      text: "Jedes CBD Boutique-Produkt wird rigoros getestet. Wir veröffentlichen alle Laborergebnisse."
    },
    cta: {
  ...
  fr: {
    hero: {
      ...
      subtitle: "CBD Boutique est né d'une conviction simple : tout le monde mérite d'accéder à des produits CBD premium qui améliorent le bien-être naturellement."
    },
    philosophy: {
      eyebrow: "Philosophie",
      title: "La nature rencontre la science",
      text1: "Nous croyons au pouvoir du CBD dérivé du chanvre pour soutenir l'équilibre et le bien-être.",
    ...
    commitment: {
      ...
      text: "Chaque produit CBD Boutique est rigoureusement testé. Nous publions tous les résultats."
    },
    cta: {
      title: "Découvrez la différence",
      subtitle: "Explorez notre collection de produits CBD premium",
