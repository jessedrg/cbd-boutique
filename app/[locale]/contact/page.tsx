...
const CONTACT_CONTENT: Record<string, {
  ...
  en: {
    hero: {
      ...
      subtitle: "Have questions about our products or need guidance? Our team of CBD experts is ready to assist you."
    },
    form: {
    ...
    info: {
      ...
      email: { label: "Email", value: "hello@cbd-boutique.com" },
  ...
  es: {
    hero: {
      ...
      subtitle: "¿Tienes preguntas sobre nuestros productos o necesitas orientación? Nuestro equipo de expertos en CBD está listo para asistirte."
    },
    form: {
    ...
    info: {
      ...
      email: { label: "Email", value: "hola@cbd-boutique.com" },
  ...
  de: {
    hero: {
      ...
      subtitle: "Haben Sie Fragen zu unseren Produkten? Unser CBD-Expertenteam hilft Ihnen gerne."
    },
    form: {
    ...
    info: {
      ...
      email: { label: "E-Mail", value: "hallo@cbd-boutique.com" },
  ...
  fr: {
    hero: {
      ...
      subtitle: "Des questions sur nos produits? Notre équipe d'experts CBD est prête à vous assister."
    },
    form: {
    ...
    info: {
      ...
      email: { label: "Email", value: "bonjour@cbd-boutique.com" },
